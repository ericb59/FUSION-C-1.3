...
void	LMMV( unsigned int DX, unsigned int DY, unsigned int NX, unsigned int NY, char COL, char OP) __naked
{
	DX,DY,NX,NY,COL,OP;
__asm
...
;**************************************************************************
; LMMV painting the rectangle in high speed with logical operation.    Eric
;
; void  LMMV( unsigned int XS, unsigned int YS, unsigned int DX, unsigned int DY, char COL, char OP);
;**************************************************************************
